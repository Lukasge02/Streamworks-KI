...
def generate_schedule_xml(
    schedule: Optional[str] = None, start_time: Optional[str] = None
) -> str:
    """
...
&lt;/SchedulingRules&gt;"""
    ...
    if any(word in schedule_lower for word in ["stündlich", "hourly", "jede stunde"]):
        return """&lt;SchedulingRules ShiftRule=&quot;3&quot;&gt;
  &lt;ScheduleMonths All=&quot;Yes&quot; /&gt;
...
&lt;/SchedulingRules&gt;"""
    ...
    # Workdays only (Mo-Fr)
    if any(
        word in schedule_lower
        for word in ["werktags", "workdays", "mo-fr", "montag bis freitag"]
    ):
        return f"""&lt;SchedulingRules ShiftRule=&quot;3&quot;&gt;
  &lt;ScheduleMonths All=&quot;Yes&quot; /&gt;
