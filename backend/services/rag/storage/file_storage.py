...
class FileStorageService:
    ...
    def save_file(self, content: bytes, filename: str, doc_id: str) -> Dict[str, Any]:
        """
    ...
    def _save_to_minio(
        self, content: bytes, stored_name: str, original_name: str
    ) -> Dict[str, Any]:
        """Save file to MinIO"""
        try:
    ...
    def get_presigned_url(
        self, doc_id: str, ext: str = None, expiry_hours: int = 1, inline: bool = True
