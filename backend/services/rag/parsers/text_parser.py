...
class TextParser(BaseParser):
    ...
    def supported_types(self) -> List[DocumentType]:
        return [DocumentType.TXT, DocumentType.MD, DocumentType.JSON, DocumentType.XML]
    ...
    def parse(self, content: bytes, filename: str, **kwargs) -> ParsedDocument:
        ...
        metadata = {"source": filename, "parsing_engine": "text_parser"}
    ...
    def parse_with_chunks(
        self, content: bytes, filename: str, chunk_size: int = 2000, overlap: int = 200
    ) -> ParsedDocument:
        """
