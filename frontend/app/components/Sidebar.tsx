...
const NAV_ITEMS = [
  {
    ...
    label: "Stream Editor",
    icon: Sparkles,
    description: "Wizard + KI-Chat",
  },
  {
    href: "/streams",
    label: "Meine Streams",
    icon: LayoutDashboard,
    description: "Gespeicherte Jobs",
  },
  {
    href: "/documents",
    label: "Dokumente",
    icon: FileText,
    description: "RAG Wissensbasis",
  },
  {
    href: "/chat",
    label: "Dokumenten-Chat",
    icon: MessageCircle,
    description: "Fragen an Dokumente",
  },
  {
    href: "/testing",
    label: "Testing",
    icon: FlaskConical,
    description: "Testfunktionen",
  },
  { href: "/wizard", label: "Wizard", icon: Wand2, description: "KI-Wizard" },
];
