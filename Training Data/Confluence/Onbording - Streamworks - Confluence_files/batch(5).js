...
Confluence.Templates.Metadata.JIRA.metadata = function(opt_data, opt_ignored) {
  var output = '<div id="jira-metadata-dialog" class="rendered-content"><h2 class="title">' + soy.$$escapeHtml('Jira-Verkn\xfcpfungen') + '</h2><div class="items-section">';
...
Confluence.Templates.Metadata.JIRA.nometadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml('Die Jira-Verkn\xfcpfungen k\xf6nnen nicht angezeigt werden. Entweder verf\xfcgen Sie nicht \xfcber die geeigneten Jira-Berechtigungen oder die Verkn\xfcpfungen wurden entfernt.') + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.JIRA.renderGroup = function(opt_data, opt_ignored) {
  ...
  for (var linkIndex130 = 0; linkIndex130 < linkListLen130; linkIndex130++) {
    ...
    output += '<li class="jira-metadata-item"><a href="' + soy.$$escapeHtml("/wiki") + '/plugins/servlet/jira-metadata/redirect?u=' + soy.$$escapeUri(linkData130.url) + '&t=' + soy.$$escapeHtml(opt_data.type) + '&more">' + soy.$$escapeHtml(AJS.format('Weitere {0} in {1} anzeigen',linkData130.numItems,linkData130.appName)) + '</a></li>';
  }
  output += '</ul></div>';
  return output;
};
...
Confluence.Templates.Metadata.JIRA.loadingMetadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog"><h2 class="title">' + soy.$$escapeHtml('Jira-Verkn\xfcpfungen') + '</h2><div class="spinner-container"><div class="spinner"></div></div></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.JIRA.renderJiraErrors = function(opt_data, opt_ignored) {
  ...
  if (opt_data.errors.length == 1) {
    ...
    output += aui.message.warning({content: '<p>' + soy.$$escapeHtml('Die Jira-Metadaten konnten nicht abgerufen werden.') + ' ' + soy.$$escapeHtml(error__soy150.errorMessage) + '</p>'});
...
Confluence.Templates.Metadata.JIRA.unknownError = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml('Die Jira-Metadaten konnten nicht abgerufen werden. Verbindung mit Confluence konnte nicht hergestellt werden') + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
define('confluence/jira-metadata', [
    ...
    function updateWebItemText($webItem, count, incomplete) {
        if (!incomplete) {
            var text = (count === 1)
                ? "1 Jira-Verkn\u00fcpfung"
                : AJS.format("{0} Jira-Verkn\u00fcpfungen", count);
